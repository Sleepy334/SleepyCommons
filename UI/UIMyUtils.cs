...
namespace SleepyCommon
{
    public class UIMyUtils
    {
        ...
        public static string GetWordWrapTooltipText(string sText)
        {
            // Insert returns at space points
            const int iLINE_WIDTH = 40;

            string sNewText = "";
            int iLineCharacters = 0;
            foreach (char c in sText)
            {
                if (iLineCharacters >= iLINE_WIDTH)
                {
